const questionsByLevel = [
  [
    { prompt: "10 UNIDADES ___ 1 DEZENA", answer: "=" },
    { prompt: "40 UNIDADES ___ 1 DEZENA", answer: ">" },
    { prompt: "1 DEZENA ___ 10 UNIDADES", answer: "=" },
    { prompt: "5 DEZENAS ___ 100 UNIDADES", answer: "<" },
    { prompt: "9 UNIDADES ___ 1 DEZENA", answer: "<" },
    { prompt: "100 UNIDADES ___ 1 CENTENA", answer: "=" },
    { prompt: "40 UNIDADES ___ 3 DEZENAS", answer: ">" },
    { prompt: "4 DEZENAS ___ 50 UNIDADES", answer: "<" }
  ],
  [
    { prompt: "9 UNIDADES ___ 9 DEZENAS", answer: "<" },
    { prompt: "9 DEZENAS ___ 1 CENTENA", answer: "<" },
    { prompt: "90 UNIDADES ___ 5 DEZENAS", answer: ">" },
    { prompt: "90 UNIDADES ___ 9 DEZENAS", answer: "=" },
    { prompt: "40 UNIDADES ___ 4 DEZENAS", answer: "=" },
    { prompt: "4 CENTENAS ___ 80 UNIDADES", answer: ">" },
    { prompt: "4 DEZENAS ___ 80 UNIDADES", answer: "<" },
    { prompt: "3 CENTENAS ___ 300 UNIDADES", answer: "=" }
  ],
  [
    { prompt: "1 UNIDADE ___ 1 DEZENA", answer: "<" },
    { prompt: "5 DEZENAS ___ 50 UNIDADES", answer: "=" },
    { prompt: "60 UNIDADES ___ 3 CENTENAS", answer: "<" },
    { prompt: "2 CENTENAS ___ 100 UNIDADES", answer: ">" },
    { prompt: "2 CENTENAS ___ 4 DEZENAS", answer: ">" },
    { prompt: "2 CENTENAS ___ 300 UNIDADES", answer: "<" },
    { prompt: "2 CENTENAS ___ 200 UNIDADES", answer: "=" },
    { prompt: "3 DEZENAS ___ 30 UNIDADES", answer: "=" }
  ]
];
...
elements.finalForm.addEventListener("submit", (event) => {
  ...
  if (guess === "PERNA") showEnding("victory");
