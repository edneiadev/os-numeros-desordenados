const questionsByLevel = [
  [
    { prompt: "1 CENTENA ___ 9 DEZENAS", answer: ">" },
    { prompt: "120 UNIDADES ___ 1 CENTENA E 2 DEZENAS", answer: "=" },
    { prompt: "250 UNIDADES ___ 2 CENTENAS E 5 UNIDADES", answer: ">" },
    { prompt: "301 UNIDADES ___ 3 CENTENAS E 1 UNIDADE", answer: "=" },
    { prompt: "470 UNIDADES ___ 4 CENTENAS E 7 DEZENAS", answer: "=" },
    { prompt: "6 CENTENAS E 4 UNIDADES ___ 640 UNIDADES", answer: "<" },
    { prompt: "130 UNIDADES ___ 1 CENTENA E 3 DEZENAS", answer: "=" },
    { prompt: "301 UNIDADES ___ 3 CENTENAS E 1 DEZENA", answer: "<" }
  ],
  [
    { prompt: "8 DEZENAS ___ 1 CENTENA", answer: "<" },
    { prompt: "2 CENTENAS ___ 220 UNIDADES", answer: "<" },
    { prompt: "3 DEZENAS ___ 3 CENTENAS", answer: "<" },
    { prompt: "320 UNIDADES ___ 3 CENTENAS E 2 UNIDADES", answer: ">" },
    { prompt: "560 UNIDADES ___ 5 CENTENAS E 6 DEZENAS", answer: "=" },
    { prompt: "890 UNIDADES ___ 9 DEZENAS", answer: ">" },
    { prompt: "760 UNIDADES ___ 8 CENTENAS", answer: "<" },
    { prompt: "760 UNIDADES ___ 7 CENTENAS E 6 UNIDADES", answer: ">" }
  ],
  [
    { prompt: "1 UNIDADE MILHAR ___ 9 CENTENAS", answer: ">" },
    { prompt: "8 CENTENAS E 9 DEZENAS ___ 9 CENTENAS", answer: "<" },
    { prompt: "2 UNIDADES DE MILHAR ___ 2000 UNIDADES", answer: "=" },
    { prompt: "1 UNIDADE DE MILHAR E 2 CENTENAS ___ 1.030 UNIDADES", answer: ">" },
    { prompt: "3 UNIDADES DE MILHAR ___ 2.987 UNIDADES", answer: ">" },
    { prompt: "3.000 UNIDADES ___ 300 UNIDADES", answer: "<" },
    { prompt: "2.000 + 3.000 ___ 6 UNIDADES DE MILHAR", answer: "<" },
    { prompt: "5 UNIDADES DE MILHAR E 5 CENTENAS ___ 5.500 UNIDADES DE MILHAR", answer: "<" }
  ]
];

const clues = [
  "TEM UMA CONSOANTE REPETIDA.",
  "COMEÇA COM A TERCEIRA LETRA DO ALFABETO.",
...
elements.finalForm.addEventListener("submit", (event) => {
  ...
  if (guess === "CARRO") showEnding("victory");
